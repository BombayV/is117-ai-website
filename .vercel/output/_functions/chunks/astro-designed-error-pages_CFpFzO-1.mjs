import {
  ak as NOOP_MIDDLEWARE_HEADER,
  al as REDIRECT_STATUS_CODES,
  A as AstroError,
  am as ActionsReturnedInvalidDataError,
...
function getActionQueryString(name) {
  const searchParams = new URLSearchParams({
    [ACTION_QUERY_PARAMS$1.actionName]: name,
  });
...
const actionResultErrorStack =
  /* @__PURE__ */ (function actionResultErrorStackFn() {
    let errorStack;
    return {
      set(stack) {
        errorStack = stack;
...
export {
  ActionError as A,
  DEFAULT_404_ROUTE as D,
  NOOP_MIDDLEWARE_FN as N,
  ACTION_RPC_ROUTE_PATTERN as a,
  ACTION_QUERY_PARAMS as b,
  default404Instance as c,
  deserializeActionResult as d,
  ensure404Route as e,
  getActionQueryString as g,
  serializeActionResult as s,
};
