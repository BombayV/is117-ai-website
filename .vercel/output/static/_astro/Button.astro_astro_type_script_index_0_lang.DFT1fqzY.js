var pr = (x, m) => () => (m || x((m = { exports: {} }).exports, m), m.exports);
var br = pr((Cr, I) => {
  var I = {};
  (function x(m, T, k, P) {
    var A = !!(
        ...
        m.HTMLCanvasElement &&
        m.HTMLCanvasElement.prototype.transferControlToOffscreen &&
        m.URL &&
        m.URL.createObjectURL
      ),
      L = typeof Path2D == "function" && typeof DOMMatrix == "function",
      _ = (function () {
        if (!m.OffscreenCanvas) return !1;
        try {
    ...
    function N() {}
    function E(e) {
      var r = T.exports.Promise,
        a = r !== void 0 ? r : m.Promise;
      return typeof a == "function" ? new a(e) : (e(N, N), null);
    }
    var F = (function (e, r) {
        return {
        ...
        return (
          ...
          typeof cancelAnimationFrame == "function"
            ? ((r = function (i) {
                var l = Math.random();
                return (
                  (t[l] = requestAnimationFrame(function n(s) {
                    o === s || o + e - 1 < s
                      ? ((o = s), delete t[l], i())
                      : (t[l] = requestAnimationFrame(n));
                  })),
                  l
                );
              }),
              ...
              return (
                (r = E(function (h) {
                  ...
                  (o.addEventListener("message", f),
                    i(n, d),
                    (a[d] = f.bind(null, { data: { callback: d } })));
                })),
                r
              );
            }),
        ...
        return function () {
          ...
          if (!k && A) {
            var o = [
              ...
              "(" + x.toString() + ")(this, module, true, SIZE);",
...
`);
    ...
    function tr(e) {
      var r = e.angle * (Math.PI / 180),
        a = e.spread * (Math.PI / 180);
      return {
        x: e.x,
        y: e.y,
    ...
    function or(e, r) {
      ...
      var a = r.tick++ / r.totalTicks,
        t = r.x + r.random * r.tiltCos,
        o = r.y + r.random * r.tiltSin,
        i = r.wobbleX + r.random * r.tiltCos,
        l = r.wobbleY + r.random * r.tiltSin;
      if (
        ((e.fillStyle =
          "rgba(" +
          r.color.r +
        ...
        var n = (Math.PI / 10) * r.wobble,
          s = Math.abs(i - t) * 0.1,
          u = Math.abs(l - o) * 0.1,
          d = r.shape.bitmap.width * r.scalar,
          h = r.shape.bitmap.height * r.scalar,
          f = new DOMMatrix([
            Math.cos(n) * s,
            Math.sin(n) * s,
            -Math.sin(n) * u,
        ...
        var g = e.createPattern(F.transform(r.shape.bitmap), "no-repeat");
        (g.setTransform(f),
          (e.globalAlpha = 1 - a),
          (e.fillStyle = g),
          e.fillRect(r.x - d / 2, r.y - h / 2, d, h),
          (e.globalAlpha = 1));
        ...
        e.ellipse
          ? e.ellipse(
              r.x,
              r.y,
              Math.abs(i - t) * r.ovalScalar,
              Math.abs(l - o) * r.ovalScalar,
              (Math.PI / 10) * r.wobble,
              0,
              2 * Math.PI,
            )
        ...
        (e.moveTo(Math.floor(r.x), Math.floor(r.y)),
          e.lineTo(Math.floor(r.wobbleX), Math.floor(o)),
          e.lineTo(Math.floor(i), Math.floor(l)),
          e.lineTo(Math.floor(t), Math.floor(r.wobbleY)));
        ...
        u = E(function (d) {
          ...
          function f() {
            (k &&
              ...
              !t.width &&
                !t.height &&
                (a(e), (t.width = e.width), (t.height = e.height)),
              l.clearRect(0, 0, t.width, t.height),
    ...
    function W(e, r) {
      var a = !e,
        t = !!v(r || {}, "resize"),
        o = !1,
        i = v(r, "disableForReducedMotion", Boolean),
        l = A && !!v(r || {}, "useWorker"),
        n = l ? q() : null,
        s = a ? rr : er,
        u = e && n ? !!e.__confetti_initialized : !1,
        d =
      ...
      function f(c, M, p) {
        for (
          var y = v(c, "particleCount", K),
            w = v(c, "angle", Number),
            C = v(c, "spread", Number),
            b = v(c, "startVelocity", Number),
            ur = v(c, "decay", Number),
            hr = v(c, "gravity", Number),
            dr = v(c, "drift", Number),
            D = v(c, "colors", $),
            fr = v(c, "ticks", Number),
            U = v(c, "shapes"),
        ...
        return h ? h.addFettis(B) : ((h = ir(e, B, s, M, p)), h.promise);
      }
      function g(c) {
        var M = i || v(c, "disableForReducedMotion", Boolean),
          p = v(c, "zIndex", Number);
        if (M && d)
          return E(function (b) {
            b();
        ...
        (a && h
          ? (e = h.canvas)
          : a && !e && ((e = ar(p)), document.body.appendChild(e)),
          t && !u && s(e));
        var y = { width: e.width, height: e.height };
        (n && !u && n.init(e), (u = !0), n && (e.__confetti_initialized = !0));
        function w() {
          if (n) {
            var b = {
              getBoundingClientRect: function () {
                if (!a) return e.getBoundingClientRect();
              },
            };
            (s(b),
              n.postMessage({ resize: { width: b.width, height: b.height } }));
            return;
          }
        ...
        function C() {
          ((h = null),
            t && ((o = !1), m.removeEventListener("resize", w)),
            a &&
              e &&
        ...
        return (
          t && !o && ((o = !0), m.addEventListener("resize", w, !1)),
    ...
    function sr(e) {
      ...
      if (!a) {
        for (
          var l = 1e3, n = l, s = l, u = 0, d = 0, h, f, g = 0;
          g < l;
          g += 2
        )
          for (var c = 0; c < l; c += 2)
            i.isPointInPath(t, g, c, "nonzero") &&
              ((n = Math.min(n, g)),
              (s = Math.min(s, c)),
              (u = Math.max(u, g)),
              (d = Math.max(d, c)));
    ...
    function cr(e) {
      ...
      typeof e == "string"
        ? (r = e)
        : ((r = e.text),
          (a = "scalar" in e ? e.scalar : a),
          (o = "fontFamily" in e ? e.fontFamily : o),
          (t = "color" in e ? e.color : t));
      var i = 10 * a,
        l = "" + i + "px " + o,
        n = new OffscreenCanvas(i, i),
        s = n.getContext("2d");
      s.font = l;
      var u = s.measureText(r),
    ...
    ((T.exports = function () {
      ...
      (T.exports.create = W),
      (T.exports.shapeFromPath = sr),
      (T.exports.shapeFromText = cr));
  })(
    (function () {
  ...
  const yr = I.exports;
  I.exports.create;
  const Z = document.body.querySelector("button");
  Z && Z.addEventListener("click", () => yr());
});
export default br();
